...
class FriendAvatarController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "AvatarCell", for: indexPath) as! FriendAvatarCell
        if !friendAvatar.isEmpty {
            cell.friendAvatar.image = UIImage(named: friendAvatar)
        }
